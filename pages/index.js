      ...
      <main className={styles.main}>
            ...
            {messages.map((message, index) => {
              return (
                ...
                <div key={index} className={message.role === "user" && loading && index === messages.length - 1 ? styles.usermessagewaiting : message.role === "assistant" ? styles.apimessage : styles.usermessage}>
                 ...
                 <div className={`${styles.markdownanswer} markdown-code`}>
        ...
        <div className={styles.center}>
          ...
          <div className={styles.footer}>
            <p>Powered by <a href="https://openai.com/" target="_blank">OpenAI</a>. Built by <a href="https://www.instagram.com/iwizef/" target="_blank">Wizef</a>.</p>
          </div>
        </div>
      </main>
    </>
